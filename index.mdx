...
sidebarTitle: "Home"
description: "LLM Council queries multiple AI models in parallel, has them peer-review each other anonymously, and synthesizes a final consensus answer via a Chairman model."
---
